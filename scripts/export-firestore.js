...
const COLLECTIONS = [
  ...
  { name: 'categories',    file: 'categories.ndjson'    },
  ...
  { name: 'fonts',         file: 'fonts.ndjson'         },
  { name: 'portfolioCategories', file: 'portfolio_categories.ndjson' },
  { name: 'portfolioPhotos', file: 'portfolio_photos.ndjson' }
];
...
async function main() {
  ...
  log(`\n${C.bold}${C.cyan}╔══════════════════════════════════════════════════╗`);
  log(`║   📦  DEKORATIV — FIRESTORE NDJSON EXPORT       ║`);
  log(`╚══════════════════════════════════════════════════╝${C.reset}\n`);
  ...
  const manifest   = {
    exportedAt,
    projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || 'dekorativ-5c737',
    collections: {},
  };
